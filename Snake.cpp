...
void Snake::initBody()
{
    for (int i = 0; i < 5; i++)
    {
        entire.push_back(Position(30 + i, 26));
    }
}
...
void Snake::Update(float eTime)
{
    ...
    if (isDied == false)
    {
        if (direction == 'l')
        {
            entire.insert(entire.begin(), Position(entire[0].x - 1, entire[0].y));
        }
        else if (direction == 'r')
        {
            entire.insert(entire.begin(), Position(entire[0].x + 1, entire[0].y));
        ...
        {
            entire.insert(entire.begin(), Position(entire[0].x, entire[0].y - 1));
        }
        else if (direction == 'd')
        {
            entire.insert(entire.begin(), Position(entire[0].x, entire[0].y + 1));
